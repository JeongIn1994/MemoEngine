...
<table style="width : 600px; border-collapse: collapse;
    ...
    <tr>
        ...
        <td style="width:500px;">
            ...
            <asp:RequiredFieldValidator ID="valName" runat="server" ErrorMessage="* 이름을 입력해주세요"
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtContent" TextMode="MultiLine" runat="server"
                Height="150px" Width="480px" CssClass="form-control" style="display:inline-block;"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="valPassword" runat="server"
                ErrorMessage="* 비밀번호를 기입해 주세요." ControlToValidate="txtPassword" Display="None"
    ...
    <tr>
        <td colspan="2" style="text-align:center">
            <asp:Button ID="btnWrite" runat="server" Text="저장"
                CssClass="btn btn-primary" OnClick="btnWrite_Click" />
